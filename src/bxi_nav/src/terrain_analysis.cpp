...
string odometryTopic = "/aft_mapped_to_init";
string laserCloudTopic = "/cloud_registered";
string terrainMapTopic = "/terrain_map";
...
int main(int argc, char **argv) {
  ...
  nh->declare_parameter<string>("odometryTopic", odometryTopic);
  nh->declare_parameter<string>("laserCloudTopic", laserCloudTopic);
  ...
  nh->get_parameter("laserCloudTopic", laserCloudTopic);
  ...
  auto subOdometry = nh->create_subscription<nav_msgs::msg::Odometry>(odometryTopic, 5, odometryHandler);

  auto subLaserCloud = nh->create_subscription<sensor_msgs::msg::PointCloud2>(laserCloudTopic, 5, laserCloudHandler);

  // auto subJoystick = nh->create_subscription<sensor_msgs::msg::Joy>("/joy", 5, joystickHandler);

  auto subClearing = nh->create_subscription<std_msgs::msg::Float32>("/map_clearing", 5, clearingHandler);

  auto pubLaserCloud = nh->create_publisher<sensor_msgs::msg::PointCloud2>(terrainMapTopic, 2);
